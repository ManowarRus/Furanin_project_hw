...
def test_list_dictionary(list_dict):
    assert list_dictionary(list_dict) == [
...
def test_list_sorted_date(list_dict, direction, sorted_list):
    assert list_sorted_date(list_dict, direction) == sorted_list
